...
import com.example.springboottemplate.config.redis.CustomCacheManager;
import com.example.springboottemplate.config.redis.CustomJackson2JsonRedisSerializer;
